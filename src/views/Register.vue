  ...
  <PageScaffold :meteor-count="25" background-type="dark">
    <div class="container mx-auto px-4 pt-24 pb-12 relative z-10">
      ...
      <div class="max-w-4xl mx-auto">
        <div class="bg-gradient-to-br from-slate-900/95 via-blue-900/95 to-indigo-900/95 rounded-2xl shadow-2xl p-8 border border-cyan-500/30">
          <!-- Title -->
            ...
            <div class="bg-slate-800/50 rounded-xl p-6 border border-slate-700">
              ...
              <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <select v-model="formData.userTitle" class="form-select cursor-pointer">
                ...
                <div>
                  ...
                  <div class="relative country-dropdown-container">
                    ...
                    <div 
                      ...
                      class="form-dropdown-menu max-h-64"
                    >
                      <div 
                ...
                <div class="md:col-span-2">
                  ...
                  <div class="relative form-dropdown area-dropdown-container">
                    <div
                      @click="showAreaDropdown = !showAreaDropdown"
                      :class="[
                        'form-dropdown-trigger min-h-[48px] flex items-center justify-between',
                        fieldErrors.userClassification && 'input-warning'
                      ]"
                    >
                  ...
                  <p v-if="fieldErrors.userClassification" class="form-help field-hint-warning">
                    {{ fieldErrors.userClassification }}
                  </p>
                </div>
              ...
              <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <select
                    ...
                    class="form-select cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed"
                  >
