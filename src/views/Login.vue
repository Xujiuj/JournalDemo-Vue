  ...
  <PageScaffold :meteor-count="25" background-type="dark">
    <div class="container mx-auto px-4 pt-24 pb-12 relative z-10">
      ...
      <div class="max-w-lg mx-auto">
        <div class="relative bg-gradient-to-br from-slate-900/98 via-blue-900/98 to-indigo-900/98 rounded-3xl shadow-2xl p-10 border border-cyan-500/50 overflow-hidden">
