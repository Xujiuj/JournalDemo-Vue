...
const handleWheel = (event) => {
  ...
  const recentPublicationsSection = document.querySelector('.recent-publications-section')
  
  if (!heroSection || !recentPublicationsSection) return
  
  const heroBottom = heroSection.getBoundingClientRect().bottom + scrollTop
  const recentPublicationsTop = recentPublicationsSection.getBoundingClientRect().top + scrollTop
